...
os.makedirs('aulas_fisica', exist_ok=True)
...
base_url = "https://webfisica.com/curso-de-fisica-basica/aula/{}-{}"
...
for aula in range(1, 105):
    ...
    arquivo_destino = f"aulas_fisica/aula_{capitulo}_{aula}.html"
